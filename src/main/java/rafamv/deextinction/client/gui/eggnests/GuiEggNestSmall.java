...
public class GuiEggNestSmall extends GuiBase
{
	private static final ResourceLocation GUI_TEXTURE_MAIN = new ResourceLocation(DeExtinction.MODID, "textures/gui/eggnests/gui_egg_nest_small.png");
	...
	private EntityEggNestSmall eggNest;

	public GuiEggNestSmall(InventoryPlayer playerInventory, EntityEggNestSmall eggNest)
	{
		super(new ContainerEggNestSmall(playerInventory, eggNest.getInventoryBasic(), eggNest));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		this.mc.getTextureManager().bindTexture(GuiEggNestSmall.GUI_TEXTURE_MAIN);
		this.drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);

		if (this.eggNest.getWatchableBoolean(EntityEggNestKeys.FLAG_THERMOMETER))
		{
			this.mc.getTextureManager().bindTexture(GuiEggNestSmall.GUI_TEXTURE_WIDGETS);
