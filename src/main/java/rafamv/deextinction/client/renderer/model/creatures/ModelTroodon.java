...
public class ModelTroodon extends ResettableModelBase
{
	...
	public ModelTroodon()
	{
		...
		this.leftArm2.addBox(-1.0F, 0.0F, -1.5F, 1, 4, 2, 0.0F);
		this.setRotateAngle(leftArm2, -1.9577358219620393F, 0.08726646259971647F, 0.0F);
		this.tail2 = new ResettableModelRenderer(this, 37, 20);
		this.tail2.setRotationPoint(0.5F, -0.5F, 8.3F);
		this.tail2.addBox(-1.5F, -1.5F, 0.0F, 2, 4, 9, 0.0F);
		this.setRotateAngle(tail2, -0.045553093477052F, 0.0F, 0.0F);
		this.headFeathers = new ResettableModelRenderer(this, 0, 0);
		this.headFeathers.setRotationPoint(-0.1F, 0.2F, -0.9F);
		this.headFeathers.addBox(0.0F, -2.4F, -0.7F, 0, 6, 8, 0.0F);
		this.setRotateAngle(headFeathers, 0.31869712141416456F, 0.0F, 0.0F);
		this.tail1 = new ResettableModelRenderer(this, 37, 0);
		this.tail1.setRotationPoint(0.0F, -1.25F, 0.0F);
		this.tail1.addBox(-1.5F, -2.0F, 0.0F, 3, 5, 10, 0.0F);
		this.setRotateAngle(tail1, 0.5009094953223726F, 0.0F, 0.0F);
		this.tailFeathers = new ResettableModelRenderer(this, 29, 55);
		this.tailFeathers.setRotationPoint(0.0F, -0.5F, 6.5F);
		...
		this.rightArm1.setRotationPoint(-3.0F, 0.0F, -3.0F);
		this.rightArm1.addBox(-1.0F, 0.0F, -1.0F, 2, 5, 2, 0.0F);
		this.setRotateAngle(rightArm1, 2.0032889154390916F, -0.6373942428283291F, -0.18203784098300857F);
		this.leftClaw = new ResettableModelRenderer(this, 0, 0);
		this.leftClaw.setRotationPoint(-0.1F, 0.6F, -1.6F);
		this.leftClaw.addBox(-1.1F, -2.4F, 0.0F, 1, 2, 1, 0.0F);
		this.setRotateAngle(leftClaw, 0.6373942428283291F, 0.0F, 0.0F);
		this.rightLeg2 = new ResettableModelRenderer(this, 3, 65);
		this.rightLeg2.mirror = true;
		this.rightLeg2.setRotationPoint(-0.5F, 3.5F, 0.0F);
		this.rightLeg2.addBox(-1.0F, 0.0F, -2.4F, 2, 8, 4, 0.0F);
		...
		this.upperjaw.addBox(-1.1F, 0.0F, -6.2F, 2, 2, 6, 0.0F);
		this.rightArmFeathers3 = new ResettableModelRenderer(this, 10, 12);
		this.rightArmFeathers3.setRotationPoint(0.0F, -0.2F, 0.3F);
		this.rightArmFeathers3.addBox(-0.4F, 0.2F, -1.2F, 0, 4, 5, 0.0F);
		this.setRotateAngle(rightArmFeathers3, 0.18203784098300857F, 0.0F, 0.0F);
		this.mainBodyMiddle = new ResettableModelRenderer(this, 91, 20);
		this.mainBodyMiddle.setRotationPoint(0.0F, 0.4F, -2.0F);
		this.mainBodyMiddle.addBox(-3.0F, -4.0F, -4.0F, 6, 7, 6, 0.0F);
		this.setRotateAngle(mainBodyMiddle, 0.17453292519943295F, 0.0F, 0.0F);
		...
		this.rightFinger2.setRotationPoint(-0.4F, 3.0F, -0.25F);
		this.rightFinger2.addBox(-0.5F, 0.0F, -1.0F, 1, 4, 1, 0.0F);
		this.setRotateAngle(rightFinger2, 1.6845917940249266F, 0.08726646259971647F, 0.0F);
		...
		this.leftArmFeathers1.addBox(0.0F, -2.75F, -1.5F, 0, 7, 4, 0.0F);
		...
		this.leftArmFeathers3.setRotationPoint(0.0F, -0.2F, -0.3F);
		this.leftArmFeathers3.addBox(0.4F, 0.0F, -0.6F, 0, 4, 5, 0.0F);
		this.setRotateAngle(leftArmFeathers3, 0.18203784098300857F, 0.0F, 0.0F);
		this.head = new ResettableModelRenderer(this, 1, 31);
		this.head.setRotationPoint(0.1F, 0.6F, 0.3F);
		this.head.addBox(-2.5F, -1.9F, -5.0F, 5, 5, 5, 0.0F);
		...
		this.leftArm1.setRotationPoint(3.0F, 0.0F, -3.0F);
		this.leftArm1.addBox(-1.0F, 0.0F, -1.0F, 2, 5, 2, 0.0F);
		this.setRotateAngle(leftArm1, 2.0032889154390916F, 0.6373942428283291F, 0.18203784098300857F);
		this.neck2 = new ResettableModelRenderer(this, 95, 71);
		this.neck2.setRotationPoint(0.0F, 0.0F, -6.7F);
		this.neck2.addBox(-1.5F, -1.25F, -4.0F, 3, 5, 6, 0.0F);
		this.setRotateAngle(neck2, 0.7285004297824331F, 0.0F, 0.0F);
		this.leftFinger2 = new ResettableModelRenderer(this, 24, 82);
		this.leftFinger2.mirror = true;
		this.leftFinger2.setRotationPoint(-0.6F, 3.0F, -0.25F);
		this.leftFinger2.addBox(-0.5F, 0.0F, -1.0F, 1, 4, 1, 0.0F);
		this.setRotateAngle(leftFinger2, 1.6845917940249266F, -0.08726646259971647F, 0.0F);
		this.tailFeathers3 = new ResettableModelRenderer(this, 47, 55);
		this.tailFeathers3.setRotationPoint(0.0F, -0.6F, 6.1F);
		...
		this.rightArm2.setRotationPoint(0.5F, 4.5F, 0.0F);
		this.rightArm2.addBox(-1.0F, 0.0F, -1.5F, 1, 4, 2, 0.0F);
		this.setRotateAngle(rightArm2, -1.9565140914856434F, -0.08726646259971647F, 0.0F);
		this.leftFoot = new ResettableModelRenderer(this, 4, 94);
		this.leftFoot.setRotationPoint(0.0F, 7.0F, 0.8F);
		this.leftFoot.addBox(-0.8F, -0.5F, -4.0F, 2, 1, 4, 0.0F);
		this.setRotateAngle(leftFoot, 0.4363323129985824F, 0.0F, 0.0F);
		this.leftLeg1 = new ResettableModelRenderer(this, 0, 48);
		this.leftLeg1.setRotationPoint(4.8F, 8.2F, 3.6F);
		this.leftLeg1.addBox(-2.0F, -2.5F, -2.5F, 3, 8, 6, 0.0F);
		this.setRotateAngle(leftLeg1, -0.4363323129985824F, 0.0F, 0.0F);
		this.mainBodyFrontMain = new ResettableModelRenderer(this, 105, 36);
		this.mainBodyFrontMain.setRotationPoint(0.0F, 0.5F, -2.0F);
		this.mainBodyFrontMain.addBox(-2.5F, -4.0F, -6.0F, 5, 7, 5, 0.0F);
		this.setRotateAngle(mainBodyFrontMain, -0.2617993877991494F, 0.0F, 0.0F);
		this.rightFoot = new ResettableModelRenderer(this, 4, 94);
		this.rightFoot.mirror = true;
		this.rightFoot.setRotationPoint(0.0F, 7.0F, 0.8F);
		this.rightFoot.addBox(-1.2F, -0.5F, -4.0F, 2, 1, 4, 0.0F);
		this.setRotateAngle(rightFoot, 0.4363323129985824F, 0.0F, 0.0F);
		this.tail3 = new ResettableModelRenderer(this, 67, 30);
		this.tail3.setRotationPoint(-0.5F, -0.2F, 8.5F);
		this.tail3.addBox(-1.0F, -1.0F, 0.0F, 2, 3, 7, 0.0F);
		this.setRotateAngle(tail3, -0.045553093477052F, 0.0F, 0.0F);
		this.rightClaw = new ResettableModelRenderer(this, 0, 0);
		this.rightClaw.setRotationPoint(0.4F, 0.8F, -1.5F);
		this.rightClaw.addBox(0.0F, -2.7F, 0.0F, 1, 2, 1, 0.0F);
		this.setRotateAngle(rightClaw, 0.6373942428283291F, 0.0F, 0.0F);
		...
		this.leftArmFeathers2.setRotationPoint(-0.4F, 1.5F, 0.0F);
		this.leftArmFeathers2.addBox(0.0F, -2.0F, -0.5F, 0, 4, 3, 0.0F);
		...
		this.mainBodyFrontMain.addChild(this.rightArm1);
		this.leftFoot.addChild(this.leftClaw);
		this.rightLeg1.addChild(this.rightLeg2);
		this.head.addChild(this.upperjaw);
		this.rightFinger2.addChild(this.rightArmFeathers3);
		this.mainBody.addChild(this.mainBodyMiddle);
		...
		this.leftFinger2.addChild(this.leftArmFeathers3);
		this.headJoint.addChild(this.head);
		this.rightLeg2.addChild(this.rightLeg3);
		this.mainBodyFrontMain.addChild(this.leftArm1);
		...
		this.mainBodyMiddle.addChild(this.mainBodyFrontMain);
		...
		this.mainBodyFrontMain.addChild(this.neck1);
	...
	{
		EntityTroodon creature = (EntityTroodon) entity;
	...
	public void setLivingAnimations(EntityLivingBase entity, float yaw, float pitch, float partialRenderTicks)
	{
		...
		if (sittingProgress > 0.01F)
		{
			...
			this.rightArm1.rotateAngleX += 0.1F * sittingProgress;
			this.rightArm2.rotateAngleX -= 0.7F * sittingProgress;

			this.leftArm1.rotateAngleX += 0.1F * sittingProgress;
			this.leftArm2.rotateAngleX -= 0.7F * sittingProgress;
			...
			this.rightLeg3.rotationPointZ -= 2.2F * sittingProgress;
			this.rightLeg3.rotateAngleX -= 1.7F * sittingProgress;
			this.rightFoot.rotationPointZ -= 0.5F * sittingProgress;
			this.rightFoot.rotateAngleX += 1.1F * sittingProgress;
			...
			this.leftLeg3.rotationPointZ -= 2.2F * sittingProgress;
			this.leftLeg3.rotateAngleX -= 1.7F * sittingProgress;
			this.leftFoot.rotationPointZ -= 0.5F * sittingProgress;
			this.leftFoot.rotateAngleX += 1.1F * sittingProgress;
		}
	...
	private void setRotationAngles(float walkedDistance, float walkSpeed, float time, float yaw, float pitch, float scale, EntityTroodon creature)
	{
