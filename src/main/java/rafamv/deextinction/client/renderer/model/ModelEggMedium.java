...
public class ModelEggMedium extends EggModelBase
{
	...
	public ModelEggMedium()
	{
		...
		this.egg_1 = new ResettableModelRenderer(this, 0, 21);
		this.egg_1.setRotationPoint(0.0F, 23.0F, 0.0F);
		this.egg_1.addBox(-2.0F, -0.5F, -2.0F, 4, 1, 4, 0.0F);
		this.egg_3 = new ResettableModelRenderer(this, 0, 5);
		this.egg_3.setRotationPoint(0.0F, -3.75F, 0.0F);
		this.egg_3.addBox(-2.0F, -0.5F, -2.0F, 4, 1, 4, 0.0F);
		this.egg_2 = new ResettableModelRenderer(this, 0, 11);
		this.egg_2.setRotationPoint(0.0F, -0.75F, 0.0F);
		this.egg_2.addBox(-2.5F, -3.5F, -2.5F, 5, 4, 5, 0.0F);
