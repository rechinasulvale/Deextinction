...
public class Eotyrannus extends EggCreature
{
	public static final String NAME = "eotyrannus_lengi";

	public Eotyrannus()
	{
		super(Eotyrannus.NAME);
	}
	...
	{
		return new GalleryPosition(7, 7);
	}
	...
	{
		this.registerPreviousCreature(Guanlong.NAME, 101);
	}
