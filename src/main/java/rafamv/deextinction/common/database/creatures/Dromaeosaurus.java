...
public class Dromaeosaurus extends EggCreature
{
	public static final String NAME = "dromaeosaurus_albertensis";

	public Dromaeosaurus()
	{
		super(Dromaeosaurus.NAME);
	}
	...
	{
		return new GalleryPosition(5, 3);
	}
	...
	{
		return DEItemRegistry.dromaeosaurus_egg;
	}
	...
	{
		this.registerPreviousCreature(Zhenyuanlong.NAME, 50);
	}
