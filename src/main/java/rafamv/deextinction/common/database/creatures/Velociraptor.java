...
public class Velociraptor extends EggCreature
{
	public static final String NAME = "velociraptor_mongoliensis";

	public Velociraptor()
	{
		super(Velociraptor.NAME);
	}
	...
	{
		return DEItemRegistry.velociraptor_egg;
	}
