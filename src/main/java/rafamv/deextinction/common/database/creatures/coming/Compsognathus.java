...
public class Compsognathus extends EggCreature
{
	public static final String NAME = "compsognathus_longipes";

	public Compsognathus()
	{
		super(Compsognathus.NAME);
	}
	...
	{
		return new GalleryPosition(3, 7);
	}
	...
	{
		this.registerPreviousCreature(Pelecanimimus.NAME, 101);
	}
