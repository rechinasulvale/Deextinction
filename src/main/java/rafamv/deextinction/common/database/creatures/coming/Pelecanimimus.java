...
public class Pelecanimimus extends EggCreature
{
	public static final String NAME = "pelecanimimus_polydon";

	public Pelecanimimus()
	{
		super(Pelecanimimus.NAME);
	}
	...
	{
		this.registerPreviousCreature(Shuvuuia.NAME, 101);
	}
