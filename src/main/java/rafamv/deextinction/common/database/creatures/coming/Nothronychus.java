...
public class Nothronychus extends EggCreature
{
	public static final String NAME = "nothronychus_mckinleyi";

	public Nothronychus()
	{
		super(Nothronychus.NAME);
	}
	...
	{
		this.registerPreviousCreature(Citipati.NAME, 101);
	}
