...
public class WorldGenSequoiadendronOrangeSmall extends WorldGenDeExtinctedTree
{
	public WorldGenSequoiadendronOrangeSmall()
	{
		super(true, DEBlockRegistry.sequoiadendron_orange_log.getDefaultState(), DEBlockRegistry.sequoiadendron_leaves.getDefaultState(), DEBlockRegistry.sequoiadendron_orange_sapling.getDefaultState());
	}
