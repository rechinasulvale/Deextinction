...
public class WorldGenSequoiadendronOrangeHuge extends WorldGenDeExtinctedTree
{
	public WorldGenSequoiadendronOrangeHuge()
	{
		super(true, DEBlockRegistry.sequoiadendron_orange_log.getDefaultState(), DEBlockRegistry.sequoiadendron_leaves.getDefaultState(), DEBlockRegistry.sequoiadendron_orange_sapling_huge.getDefaultState());
	}
