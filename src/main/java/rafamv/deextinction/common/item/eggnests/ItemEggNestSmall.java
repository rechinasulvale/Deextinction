...
public class ItemEggNestSmall extends Item
{

	public ItemEggNestSmall()
	{
		super();
		this.setUnlocalizedName("item_egg_nest_small");
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		if (worldIn.isAirBlock(pos))
		{
			...
			Entity eggNest = new EntityEggNestSmall(worldIn);
			if (eggNest != null)
			{
				if (!worldIn.isRemote)
				{
