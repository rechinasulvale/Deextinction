...
public class ItemEggNestLarge extends Item
{

	public ItemEggNestLarge()
	{
		super();
		this.setUnlocalizedName("item_egg_nest_large");
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		if (worldIn.isAirBlock(pos))
		{
			...
			Entity eggNest = new EntityEggNestLarge(worldIn);
			if (eggNest != null)
			{
				if (!worldIn.isRemote)
				{
