...
public class EntityVelociraptor extends EntityDeExtinctedPack
{
	...
	static
	{
		EntityVelociraptor.foodList.add(Items.beef);
		EntityVelociraptor.foodList.add(Items.porkchop);
		EntityVelociraptor.foodList.add(Items.chicken);
		EntityVelociraptor.foodList.add(Items.mutton);
		EntityVelociraptor.foodList.add(Items.fish);
		EntityVelociraptor.foodList.add(Items.cooked_beef);
		EntityVelociraptor.foodList.add(Items.cooked_porkchop);
		EntityVelociraptor.foodList.add(Items.cooked_chicken);
		EntityVelociraptor.foodList.add(Items.cooked_mutton);
		EntityVelociraptor.foodList.add(Items.cooked_fish);
		EntityVelociraptor.foodList.add(Items.bone);
	}
	...
	{
		return DEDatabaseRegistry.LIST_DEEXTINCT_CREATURES.get(Velociraptor.NAME);
	}
