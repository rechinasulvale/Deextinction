...
public class EntityGuanlong extends EntityDeExtinctedPack
{
	...
	static
	{
		EntityGuanlong.foodList.add(Items.beef);
		EntityGuanlong.foodList.add(Items.porkchop);
		EntityGuanlong.foodList.add(Items.chicken);
		EntityGuanlong.foodList.add(Items.mutton);
		EntityGuanlong.foodList.add(Items.fish);
		EntityGuanlong.foodList.add(Items.cooked_beef);
		EntityGuanlong.foodList.add(Items.cooked_porkchop);
		EntityGuanlong.foodList.add(Items.cooked_chicken);
		EntityGuanlong.foodList.add(Items.cooked_mutton);
		EntityGuanlong.foodList.add(Items.cooked_fish);
		EntityGuanlong.foodList.add(Items.bone);
	}

	public EntityGuanlong(World worldIn)
	{
		super(worldIn);
	...
	{
		return DEDatabaseRegistry.LIST_DEEXTINCT_CREATURES.get(Guanlong.NAME);
	}
