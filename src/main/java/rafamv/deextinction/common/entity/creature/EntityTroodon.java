...
public class EntityTroodon extends EntityDeExtinctedPack
{
	...
	static
	{
		EntityTroodon.foodList.add(Items.beef);
		EntityTroodon.foodList.add(Items.porkchop);
		EntityTroodon.foodList.add(Items.chicken);
		EntityTroodon.foodList.add(Items.mutton);
		EntityTroodon.foodList.add(Items.fish);
		EntityTroodon.foodList.add(Items.cooked_beef);
		EntityTroodon.foodList.add(Items.cooked_porkchop);
		EntityTroodon.foodList.add(Items.cooked_chicken);
		EntityTroodon.foodList.add(Items.cooked_mutton);
		EntityTroodon.foodList.add(Items.cooked_fish);
		EntityTroodon.foodList.add(Items.bone);
	}
	...
	{
		return DEDatabaseRegistry.LIST_DEEXTINCT_CREATURES.get(Troodon.NAME);
	}
