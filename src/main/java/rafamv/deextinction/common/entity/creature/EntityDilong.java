...
public class EntityDilong extends EntityDeExtinctedPack
{
	...
	static
	{
		EntityDilong.foodList.add(Items.beef);
		EntityDilong.foodList.add(Items.porkchop);
		EntityDilong.foodList.add(Items.chicken);
		EntityDilong.foodList.add(Items.mutton);
		EntityDilong.foodList.add(Items.fish);
		EntityDilong.foodList.add(Items.cooked_beef);
		EntityDilong.foodList.add(Items.cooked_porkchop);
		EntityDilong.foodList.add(Items.cooked_chicken);
		EntityDilong.foodList.add(Items.cooked_mutton);
		EntityDilong.foodList.add(Items.cooked_fish);
		EntityDilong.foodList.add(Items.bone);
	}

	public EntityDilong(World worldIn)
	{
		super(worldIn);
	...
	public void onUpdate()
	{
		...
		{
			this.tailBuffer.update(5, 45.0F, 4.0F);
	...
	{
		return DEDatabaseRegistry.LIST_DEEXTINCT_CREATURES.get(Dilong.NAME);
	}
