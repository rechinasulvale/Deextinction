...
public class EntityZhenyuanlong extends EntityDeExtinctedPack
{
	...
	static
	{
		EntityZhenyuanlong.foodList.add(Items.beef);
		EntityZhenyuanlong.foodList.add(Items.porkchop);
		EntityZhenyuanlong.foodList.add(Items.chicken);
		EntityZhenyuanlong.foodList.add(Items.mutton);
		EntityZhenyuanlong.foodList.add(Items.fish);
		EntityZhenyuanlong.foodList.add(Items.cooked_beef);
		EntityZhenyuanlong.foodList.add(Items.cooked_porkchop);
		EntityZhenyuanlong.foodList.add(Items.cooked_chicken);
		EntityZhenyuanlong.foodList.add(Items.cooked_mutton);
		EntityZhenyuanlong.foodList.add(Items.cooked_fish);
		EntityZhenyuanlong.foodList.add(Items.bone);
	}

	public EntityZhenyuanlong(World worldIn)
	{
		super(worldIn);
	...
	{
		return DEDatabaseRegistry.LIST_DEEXTINCT_CREATURES.get(Zhenyuanlong.NAME);
	}
