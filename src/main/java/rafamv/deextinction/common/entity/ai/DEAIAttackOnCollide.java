...
public class DEAIAttackOnCollide extends EntityAIBase
{
	...
	public DEAIAttackOnCollide(EntityDeExtinctedAgeable creature, Class classTarget, boolean longMemory)
	{
		this(creature, longMemory);
		this.classTarget = classTarget;
		this.canPenalize = classTarget == null || !net.minecraft.entity.player.EntityPlayer.class.isAssignableFrom(classTarget);
	}

	public DEAIAttackOnCollide(EntityDeExtinctedAgeable creature, boolean longMemory)
	{
