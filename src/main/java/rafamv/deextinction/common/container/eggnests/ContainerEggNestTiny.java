...
public class ContainerEggNestTiny extends Container
{
	private EntityEggNestTiny eggNest;

	public ContainerEggNestTiny(InventoryPlayer playerInventory, IInventory eggNestInventory, EntityEggNestTiny eggNest)
	{
		...
		this.addSlotToContainer(new Slot(eggNestInventory, 0, 61, 31)
		{
			...
			{
				return super.isItemValid(itemStack) && itemStack != null && itemStack.getItem() instanceof ItemCreatureEggTiny;
			}
		...
		this.addSlotToContainer(new Slot(eggNestInventory, 1, 48, 57)
		{
			@Override
			public boolean isItemValid(ItemStack itemStack)
			{
		...
		this.addSlotToContainer(new Slot(eggNestInventory, 2, 74, 57)
		{
			@Override
			public boolean isItemValid(ItemStack itemStack)
			{
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
	{
		if (!playerIn.worldObj.isRemote)
		{
			...
			if (slot != null && slot.getHasStack())
			{
				...
				{
					if (stackInSlot.getItem() instanceof ItemCreatureEggTiny)
					{
