...
public class ContainerEggNestSmall extends Container
{
	private EntityEggNestSmall eggNest;

	public ContainerEggNestSmall(InventoryPlayer playerInventory, IInventory eggNestInventory, EntityEggNestSmall eggNest)
	{
		...
		this.addSlotToContainer(new Slot(eggNestInventory, 0, 61, 31)
		{
			...
			{
				return super.isItemValid(itemStack) && itemStack != null && itemStack.getItem() instanceof ItemCreatureEggSmall;
			}
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
	{
		if (!playerIn.worldObj.isRemote)
		{
			...
			if (slot != null && slot.getHasStack())
			{
				...
				{
					if (stackInSlot.getItem() instanceof ItemCreatureEggSmall)
					{
