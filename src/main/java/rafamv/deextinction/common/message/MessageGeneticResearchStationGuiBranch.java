...
public class MessageGeneticResearchStationGuiBranch implements IMessage
{
	private int xCoord;
	private int yCoord;
	private int zCoord;
	...
	public MessageGeneticResearchStationGuiBranch()
	{
		this.messageIsValid = false;
	}

	public MessageGeneticResearchStationGuiBranch(int xCoord, int yCoord, int zCoord, int gui_branch)
	{
		this.xCoord = xCoord;
		this.yCoord = yCoord;
		this.zCoord = zCoord;
	...
	public static class Handler implements IMessageHandler<MessageGeneticResearchStationGuiBranch, IMessage>
	{
		@Override
		public IMessage onMessage(final MessageGeneticResearchStationGuiBranch message, MessageContext ctx)
		{
			...
			playerWorldServer.addScheduledTask(new Runnable()
			{
				...
				private void processMessage(MessageGeneticResearchStationGuiBranch message, EntityPlayerMP sendingPlayer)
				{
