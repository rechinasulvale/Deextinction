...
public class BlockLowSecurityWire extends BlockOriented
{

	public BlockLowSecurityWire()
	{
		super(Material.rock);
		this.setUnlocalizedName("block_low_security_fence_wire");
	...
	private void setDefaultFacing(World worldIn, BlockPos pos, IBlockState state)
	{
		if (!worldIn.isRemote)
		{
			...
			if (blockNorth instanceof BlockLowSecurityPole || blockNorth instanceof BlockLowSecurityWire)
			{
			...
			if (blockEast instanceof BlockLowSecurityPole || blockEast instanceof BlockLowSecurityWire)
			{
			...
			if (blockSouth instanceof BlockLowSecurityPole || blockSouth instanceof BlockLowSecurityWire)
			{
			...
			if (blockWest instanceof BlockLowSecurityPole || blockWest instanceof BlockLowSecurityWire)
			{
